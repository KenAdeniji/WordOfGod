...
namespace WordEngineering
{
 ...
 /// <remarks>
 ///  ajax.schwarz-interactive.de Michael Schwarz: Asynchronous JavaScript with XmlHttpRequest
 ///  DeveloperFusion.co.uk/show/4704/3/  Karl Seguin: Implementing AJAX in ASP.NET - Setting up the Page
 /// </remarks>
