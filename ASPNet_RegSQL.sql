...
BEGIN
    ...
    IF (EXISTS(SELECT PathId FROM dbo.aspnet_PersonalizationAllUsers WHERE PathId = @PathId))
        UPDATE dbo.aspnet_PersonalizationAllUsers SET PageSettings = @PageSettings, LastUpdatedDate = @DateTimeNowUTC WHERE PathId = @PathId
    ELSE
        INSERT INTO dbo.aspnet_PersonalizationAllUsers(PathId, PageSettings, LastUpdatedDate) VALUES (@PathId, @PageSettings, @DateTimeNowUTC)
    RETURN 0
END
GO
...
BEGIN
    ...
    IF (EXISTS(SELECT PathId FROM dbo.aspnet_PersonalizationPerUser WHERE UserId = @UserId AND PathId = @PathId))
        UPDATE dbo.aspnet_PersonalizationPerUser SET PageSettings = @PageSettings, LastUpdatedDate = @DateTimeNowUTC WHERE UserId = @UserId AND PathId = @PathId
    ELSE
        INSERT INTO dbo.aspnet_PersonalizationPerUser(UserId, PathId, PageSettings, LastUpdatedDate) VALUES (@UserId, @PathId, @PageSettings, @DateTimeNowUTC)
    RETURN 0
END
GO
...
AS
BEGIN
    IF (NOT(@InactiveSinceDate IS NULL) AND @InactiveSinceDate > CONVERT(DATETIME, '17540101', 112) AND @InactiveSinceDate < CONVERT(DATETIME, '99990101', 112))
        SELECT @InactiveSinceDate = DATEADD(n, -@TimeZoneAdjustment, @InactiveSinceDate)
    ...
    BEGIN
        ...
        FROM dbo.aspnet_Paths Paths,
             (SELECT PageIndex.ItemId AS PathId,
                     DATEADD(n, @TimeZoneAdjustment, AllUsers.LastUpdatedDate) AS LastUpdatedDate,
        ...
        WHERE Paths.PathId = SharedDataPerPath.PathId AND Paths.PathId = UserDataPerPath.PathId
        ORDER BY Paths.Path ASC
    END
    ELSE
    BEGIN
        ...
        SELECT Paths.Path, DATEADD(n, @TimeZoneAdjustment, PerUser.LastUpdatedDate), DATALENGTH(PerUser.PageSettings), Users.UserName, DATEADD(n, @TimeZoneAdjustment, Users.LastActivityDate)
