...
// csc /r:system.dll /r:system.data.dll /r:system.xml.dll PopulateBibleDatabasePeoplesNewTestament.cs

namespace WordEngineering
{
 public class PopulateBibleDatabasePeoplesNewTestament
 {
  ...
  public const string         DatabaseConnectionStringSource                         = "Provider=Microsoft.Jet.OLEDB.4.0; Data Source=\\Bible\\BibleDatabase\\BibleDatabase_-_PeoplesNewTestament.mdb";
  ...
  public const string         SelectQuery                                            = "SELECT BIB_ID, bookNum, chapter, verse, narration  FROM b_pnt";
  public const string         SourceTable                                            = "SourceTable";  
  public const string         StoredProcedure                                        = "PopulateBibleDatabasePeoplesNewTestament";  
 ...
 }//PopulateBibleDatabasePeoplesNewTestament class.
