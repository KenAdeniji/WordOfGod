...
namespace WordEngineering
{
    ...
    public static class UtilityEnum
    {
        ...
        /// ConnectStates connectState = (ConnectStates) EnumParse(typeof(ConnectStates), "Proxy");
        /// </summary>
        public static object EnumParse(Type enumType, string enumDescription)
        {
            object enumValue = Enum.Parse(enumType, enumDescription, true);
            return(enumValue);
        }
    }
}