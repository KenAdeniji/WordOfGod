    ...
    <ie:PageView id="page1">
     ...
     <table>
      ...
      <asp:RequiredFieldValidator
           ID="RequiredFieldValidatorMedicalRecordPatientNo"
           ControlToValidate="TextBoxMedicalRecordPatientNo"
           ErrorMessage="Please enter a Medical Record Patient No.<br>"
           Display="Dynamic"
           runat="server"/> 

      <asp:RequiredFieldValidator
           ID="RequiredFieldValidatorAccountNo"
           ControlToValidate="TextBoxAccountNo"
           ErrorMessage="Please enter an Account No.<br>"
           Display="Dynamic"
           runat="server"/> 
      ...
      <tr>
       <td>(19)HOD (Calc field)</td>
      </tr> 

      <tr>
       <td>(20)Current Location:</td>
       <td><asp:TextBox runat="server" id="TextBoxCurrentLocation" columns="1" /></td>
      </tr>
      <tr>
       <td>[1]4E</td>
       <td>[2]5E</td>
      ...
      <tr>
       <td>(21)Room:</td>
       <td><asp:TextBox runat="server" id="TextBoxRoom"  /></td>
       <td>(21)Bed:</td>
       <td><asp:TextBox runat="server" id="TextBoxBed"  /></td>
       </tr>
