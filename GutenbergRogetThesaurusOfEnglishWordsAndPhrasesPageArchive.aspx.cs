...
{
 /// <summary>Project Gutenberg: Roget's Thesaurus of English Words and Phrases Web Form Page.</summary>
 public class GutenbergRogetThesaurusOfEnglishWordsAndPhrasesPage : Page
 {
  ...
  public void PageSubmit()
  {
   ...
   GutenbergRogetThesaurusOfEnglishWordsAndPhrases.Search
   (
        dictionaryWordQuery,
    ref exceptionMessage,
    ref sbResultElement
 ...
 }//GutenbergRogetThesaurusOfEnglishWordsAndPhrasesPage class.
