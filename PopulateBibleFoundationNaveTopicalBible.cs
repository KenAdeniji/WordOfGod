...
namespace WordEngineering
{
 ...
 ///</remarks>
 public class PopulateBibleFoundationNaveTopicalBible
 {
  ...
  public const string         StoredProcedure                   = "PopulateBibleFoundationNaveTopicalBible";
  public const string         SourceDirectory                   = @"C:\unzipped\BibleFoundation_-_NaveTopicalBible";  
  ...
  )
  {
   ...
   try
   {
    ...
    //Read the first file line, Five Digit Word Number.
    ...
    while (streamReader.Peek() > -1)
    {
     ...
     System.Console.WriteLine("Word:       {0}", dictionaryWord);
